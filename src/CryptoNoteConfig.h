...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 19023;
...
const uint64_t DIFFICULTY_WINDOW_V3                          = 24 * 60 * 60 / DIFFICULTY_TARGET;
...
const uint64_t MAXIMUM_MIXIN_V2                              = 50;

const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 150000;
...
const uint64_t DEFAULT_DUST_THRESHOLD_V2                     = UINT64_C(100000);
...
const uint32_t UPGRADE_HEIGHT_V2                             = 150000;
const uint32_t UPGRADE_HEIGHT_V3                             = 500000;
const uint32_t UPGRADE_HEIGHT_V4                             = 1000000; // Upgrade height for CN-Lite Variant 1 switch.
...
const uint8_t CURRENT_FORK_INDEX = 2;
...
const char     CRYPTONOTE_NAME[]                             = "bitminercoin";
...
const int      P2P_DEFAULT_PORT                              =  11976;
const int      RPC_DEFAULT_PORT                              =  12976;
